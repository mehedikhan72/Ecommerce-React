            ...
            <div className='relative w-screen h-[120px] bg-black text-white drop-shadow-lg z-[99]'>
                <div className='pr-4 px-2 flex justify-between items-center w-full h-full'>
                    <div className='flex items-center '>
                        <img className='h-24 w-24 mr-2' src="https://scontent.fdac157-1.fna.fbcdn.net/v/t1.15752-9/345982342_265372065935416_4394335903545513174_n.png?_nc_cat=106&ccb=1-7&_nc_sid=ae9488&_nc_eui2=AeF3RSFTcp0ecB6pBwK6z2fTw0YuOK3xp-3DRi44rfGn7d1uOmkKmKrXAZEo-rfsBJWk_J5m0nhmj9xk-0U_nqCI&_nc_ohc=E3bTb3aVXs8AX9w6utz&_nc_ht=scontent.fdac157-1.fna&oh=03_AdTjUrltXhmzO5QH-amwH899VsD3GKrC2aF_G6l_ZaDoJQ&oe=6485717B" />
